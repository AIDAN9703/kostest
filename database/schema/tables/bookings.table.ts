...
export const bookings = pgTable("booking", {
  ...
  // ADMIN WORKFLOW
  // ==========================================================================
  // assignedAdminId: Current operational state - who is handling this booking now
  // (Useful for filtering "my bookings". Historical assignments in booking_admin_notes)
