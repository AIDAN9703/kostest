 ...
 * 
 * Internal notes left by admins about a booking.
 * Replaces the single "contactedAt" field with full note history.
 * 
 * Enables:
 * - Multiple notes over time
 * - Categorized notes (contacted, follow-up, issues)
 * - Full admin communication history
 */
export const bookingAdminNotes = pgTable("booking_admin_note", {
