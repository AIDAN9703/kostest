            ...
            <div className=" bg-white/60 backdrop-blur-sm rounded-xl">
              <div className="space-y-2">
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => 
                      setPreferences(prev => ({ ...prev, emailOffers: !!checked }))
                    }
                  />
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    id="textUpdates"
                    checked={preferences.textUpdates}
                    onCheckedChange={(checked) => 
                      setPreferences(prev => ({ ...prev, textUpdates: !!checked }))
                    }
                  />
                  <label htmlFor="textUpdates" className="text-sm text-gray-700">
                    Send text updates about my booking
                  </label>
                </div>
              </div>
            </div>
