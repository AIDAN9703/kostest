...
import { serializeInquiryParams } from "../searchParams";
...
export function AdminInquiryTablePagination({
  totalCount,
  totalPages,
  page,
  limit,
}: AdminInquiryTablePaginationProps) {
  ...
  const makeHref = (newPage: number) => {
    const query = serializeInquiryParams(searchParams, { page: newPage });
