            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  className="group"
                >
                  <div className="bg-white/90 backdrop-blur-xs rounded-xl p-4 md:p-6 shadow-md 
                    ...
                    <div className="flex items-start gap-3 mb-3">
                      <div className={`shrink-0 inline-flex p-3 rounded-lg bg-linear-to-r ${feature.accent} 
