      ...
      <div className="space-y-2">
        ...
        >
          <Label
            ...
            className={`flex cursor-pointer items-center gap-3 rounded-xl border p-4 shadow-sm transition-all hover:bg-muted/20 ${
          ...
          <Label
            ...
            className={`flex cursor-pointer items-center gap-3 rounded-xl border p-4 shadow-sm transition-all hover:bg-muted/20 ${
              customerType === "guest" ? "border-primary bg-primary/5" : "border-border/60 bg-card"
            }`}
          >
