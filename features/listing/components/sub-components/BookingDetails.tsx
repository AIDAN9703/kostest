...
export function BookingDetails({ boat }: BookingDetailsProps) {
  ...
  const defaultCancellationPolicy = `- 7+ Days Notice: Full refund (excluding holidays or special cases).
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="space-y-6">
          ...
          <SpecItem
            ...
            value={
              (boat as any)["advanceBookingDays"]
                ? `${(boat as any)["advanceBookingDays"]} days`
                : "Call for details"
            }
          />
        </div>
