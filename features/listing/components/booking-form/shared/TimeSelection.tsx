          ...
          <div className="w-full border-b border-gray-100 p-4">
            <div className="flex items-center gap-3 w-full">
              {selectedDate ? (
                isMobile ? (
                  <>
                    <button type="button" className="flex items-center gap-3 w-full" onClick={() => setMobileOpen(true)}>
                      <div className="flex-1 text-left">
                        <div className="text-sm font-semibold text-primary">{currentTime || "Select Start Time"}</div>
                ...
                >
                  <PopoverTrigger asChild>
                    <div data-ts-trigger className="flex items-center gap-3 w-full cursor-pointer">
                      <div className="flex-1 text-left">
                      ...
                      <AlarmClockPlus className={cn("h-5 w-5 text-primary transition-transform", open && "rotate-180")} />
                    </div>
                  </PopoverTrigger>
                  <PopoverContent
                    align="start"
                ...
                <div className="flex items-center gap-3 w-full cursor-not-allowed opacity-50">
                  <div className="flex-1 text-left">
                    ...
                    <div className="text-xs text-slate-500">Start time unlocks after selecting date</div>
                  </div>
                  <AlarmClockPlus className="h-5 w-5 text-primary" />
                </div>
              )}
