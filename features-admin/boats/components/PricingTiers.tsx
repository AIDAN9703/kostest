...
import { pricingTierSchema, PricingTierInput } from "@/features-admin/_validation/boats";
...
export function PricingTiers({ tiers = [], onChange }: PricingTiersProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      {tiers.length === 0 ? (
        <div className="text-center p-6 border border-dashed border-gray-300 rounded-md bg-gray-50">
