      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        <Card>
          <CardContent className="pt-6">
            ...
            <div className="mt-4 flex">
              <Button size="sm" className="text-xs">Transfer to Bank</Button>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="pt-6">
            ...
            <div className="mt-4 flex">
              <Button size="sm" variant="outline" className="text-xs">Schedule Payout</Button>
            </div>
          </CardContent>
        </Card>
      </div>
            ...
            <CardContent className="p-0">
              ...
              <div className="flex items-center justify-between px-4 py-4 border-t">
                <div className="text-sm text-gray-500">
                  Showing <strong>5</strong> of <strong>127</strong> transactions
                </div>
                <div className="flex items-center gap-2">
        ...
        <TabsContent value="settings" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure your Stripe integration settings</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-500">Connected to Stripe Live API</span>
                </div>
              </div>
                ...
                <div className="rounded-md bg-gray-50 p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="font-mono text-xs text-gray-500">pk_live_•••••••••••••••••••••••••••</p>
                    </div>
                  ...
                  <div className="mt-3 flex items-center justify-between">
                    <div>
                      ...
                      <p className="font-mono text-xs text-gray-500">sk_live_•••••••••••••••••••••••••••</p>
                    </div>
                    <Button variant="outline" size="sm">Show</Button>
                  </div>
                </div>
                ...
                <div className="rounded-md bg-gray-50 p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="font-mono text-xs text-gray-500">https://kos-yachts.com/api/stripe/webhook</p>
                    </div>
                  ...
                  <div className="mt-3 flex items-center justify-between">
                    <div>
                      ...
                      <p className="font-mono text-xs text-gray-500">whsec_•••••••••••••••••••••••••••</p>
                    </div>
                    <Button variant="outline" size="sm">Show</Button>
                  </div>
                </div>
