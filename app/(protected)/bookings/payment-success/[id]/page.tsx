  ...
  useEffect(() => {
    ...
    const fetchBooking = async () => {
      try {
        ...
        // Deserialize superjson response with proper typing
        const data = superjson.deserialize<ApiResponse<BookingDetails>>(json);

        console.log("[Payment Success] Booking fetch response:", {
        ...
        if (!data.success || !data.data) {
          console.error("[Payment Success] Booking fetch failed:", {
            success: data.success,
            error: data.error,
            data: data.data,
          });
