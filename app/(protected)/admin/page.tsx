...
import { COLOR_THEMES, type ColorTheme } from "@/shared/lib/constants";
...
const METRIC_CARDS = [
  {
    ...
    getValue: (stats: Awaited<ReturnType<typeof getDashboardStats>>) =>
      stats.totalBoats,
    getTrend: (stats: Awaited<ReturnType<typeof getDashboardStats>>) =>
      stats.comparisonStats.boatsTrend,
  },
  {
    title: "Users",
    ...
    getValue: (stats: Awaited<ReturnType<typeof getDashboardStats>>) =>
      stats.totalUsers,
    getTrend: (stats: Awaited<ReturnType<typeof getDashboardStats>>) =>
      stats.comparisonStats.usersTrend,
  },
  {
    title: "Bookings",
    subtitle: "This month",
    ...
    getTrend: (stats: Awaited<ReturnType<typeof getDashboardStats>>) =>
      stats.comparisonStats.bookingsTrend,
  },
  {
    title: "Revenue",
    subtitle: "This month",
    ...
    getTrend: (stats: Awaited<ReturnType<typeof getDashboardStats>>) =>
      stats.comparisonStats.revenueTrend,
    skipFormat: true,
  },
] as const;
