              ...
              <Link key={post.id} href={`/news/${post.slug}`} className="group">
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="text-xl font-medium text-primary mb-3 leading-tight hover:text-primary/80 transition-colors">
                      {post.title}
                    </h3>
                    ...
                    <Button
                      variant="outline"
                      className="border-primary text-primary hover:bg-primary hover:text-white group-hover:bg-primary group-hover:text-white w-fit text-sm"
                    >
                      Read More
                      <ArrowRight className="ml-2 h-4 w-4" />
                    </Button>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 mb-8 text-lg font-light max-w-2xl mx-auto">
            ...
            and insider tips for your next yacht charter experience.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg font-light max-w-2xl mx-auto mb-8">
              Follow our journey and see the latest from our charters and fleet
              updates.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            >
              <Button className="bg-linear-to-r from-purple-500 to-pink-500 text-white hover:from-purple-600 hover:to-pink-600 px-8 py-3">
                <Instagram className="mr-2 h-5 w-5" />
                Follow @kosyachts on Instagram
              </Button>
            </Link>
          </div>
        </div>
