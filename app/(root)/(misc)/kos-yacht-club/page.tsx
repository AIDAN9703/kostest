      ...
      <div className="relative z-10 h-full flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-2xl mx-auto text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact">
              <Button size="lg" className="bg-primary text-white hover:bg-primary/90 px-8 py-4 font-medium">
                Get Notified
            ...
            <Link href="mailto:contact@kosyachts.com">
              <Button size="lg" variant="outline" className="text-white border-white/40 hover:bg-white/10 px-8 py-4 font-medium">
