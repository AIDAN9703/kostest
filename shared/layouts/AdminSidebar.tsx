...
import { ADMIN_NAV_ITEMS, ADMIN_FOOTER_NAV_ITEMS } from "@/shared/constants/navigation-data";
          ...
          {ADMIN_NAV_ITEMS.map((item) => {
            ...
            return (
              <li key={item.href}>
                ...
                >
                  <div className={cn("shrink-0", isActive ? "text-primary" : "text-white/80")}>
                    {item.icon}
                  </div>
              ...
              <li key={item.href}>
                <Link
                  ...
                  className={cn(
                    ...
                    isDanger ? "hover:bg-red-500/10 hover:text-white" : "hover:bg-white/10",
                    isCollapsed ? "justify-center" : "justify-start"
                  )}
                >
