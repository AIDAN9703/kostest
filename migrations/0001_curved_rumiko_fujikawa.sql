...
--> statement-breakpoint
ALTER TABLE "boat" ADD COLUMN "has_calendar" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "availability_holds" ADD CONSTRAINT "availability_holds_boat_id_boat_id_fk" FOREIGN KEY ("boat_id") REFERENCES "public"."boat"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "availability_holds" ADD CONSTRAINT "availability_holds_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "boat_availability" ADD CONSTRAINT "boat_availability_boat_id_boat_id_fk" FOREIGN KEY ("boat_id") REFERENCES "public"."boat"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "boat_calendars" ADD CONSTRAINT "boat_calendars_boat_id_boat_id_fk" FOREIGN KEY ("boat_id") REFERENCES "public"."boat"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "calendar_credentials" ADD CONSTRAINT "calendar_credentials_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "calendar_sync_logs" ADD CONSTRAINT "calendar_sync_logs_boat_calendar_id_boat_calendars_id_fk" FOREIGN KEY ("boat_calendar_id") REFERENCES "public"."boat_calendars"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "availability_holds_expires_idx" ON "availability_holds" USING btree ("expires_at");--> statement-breakpoint
...
CREATE INDEX "calendar_credentials_user_idx" ON "calendar_credentials" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "calendar_sync_logs_boat_calendar_idx" ON "calendar_sync_logs" USING btree ("boat_calendar_id");--> statement-breakpoint
CREATE INDEX "calendar_sync_logs_status_idx" ON "calendar_sync_logs" USING btree ("status");